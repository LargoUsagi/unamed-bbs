...
pub fn build(b: *std.Build) void {
    ...
    // ZigZag TUI framework (https://github.com/meszmate/zigzag), used for the
    ...
    const mod = b.addModule("bbs", .{
        // The root source file is the "entry point" of this module. Users of
        // this module will only be able to access public declarations contained
        // in this file, which means that if you have declarations that you
        // intend to expose to consumers that were defined in other files part
        // of this module, you will have to make sure to re-export them from the
        // root file.
        .root_source_file = b.path("src/root.zig"),
        // Later on we'll use this module as the root module of a test executable
        // which requires us to specify a target.
        .target = target,
        // The shared store module (re-exported via root.zig) uses sqlite, so
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "bbs" is the name you will use in your source code to
                // import this module (e.g. `@import("bbs")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "bbs", .module = mod },
                // Terminal UI framework, used by src/tui.zig.
    ...
    // --- Run server step ---
    const run_server_step = b.step("run-server", "Run the bulletin server");
    ...
    // Test executable for the server module.
